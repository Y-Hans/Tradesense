ALTER TABLE public.trades ADD COLUMN client_order_id UUID UNIQUE;
...
BEGIN
  ...
  VALUES (v_user_id, p_symbol, 'buy'::trade_side, 'market'::order_type, p_quantity, p_execution_price_inr, v_total_cost, p_stop_loss_price_inr, v_discipline_score, v_risk_score, p_client_order_id)
...
BEGIN
  ...
  VALUES (v_user_id, p_symbol, 'sell'::trade_side, 'market'::order_type, p_quantity, p_execution_price_inr, v_total_proceeds, v_discipline_score, v_risk_score, p_client_order_id)
  RETURNING id INTO v_trade_id;
