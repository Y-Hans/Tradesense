...
void main() {
  testWidgets('OnboardingScreen renders 3 pages and triggers onGetStarted',
    ...
    await tester.drag(
        find.text('Practice Crypto Safely'), const Offset(-500.0, 0.0));
    await tester.pumpAndSettle();

    // Page 2 is visible
    expect(find.text('₹100,000 Virtual Starting Balance'), findsOneWidget);

    await tester.drag(find.text('₹100,000 Virtual Starting Balance'),
