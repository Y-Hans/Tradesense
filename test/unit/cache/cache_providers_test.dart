...
void main() {
  group('Cache Riverpod Providers Unit Tests', () {
    ...
    test('createCacheRepositoryProvider creates strongly typed repository', () async {
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('overriding cacheClockProvider controls time deterministically in providers', () async {
      ...
      expect((hitResult as CacheHit<String>).entry.createdAt, equals(fixedTime));
    });

    test('overriding cacheStorageProvider uses custom storage implementation', () async {
