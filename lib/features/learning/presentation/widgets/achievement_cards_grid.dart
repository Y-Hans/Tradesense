...
import '../../domain/achievement.dart' as domain;

typedef AchievementRarity = domain.AchievementRarity;
...
class AchievementModel {
  ...
  factory AchievementModel.fromDomain(domain.Achievement achievement) {
    return AchievementModel(
      title: achievement.title,
      description: achievement.description,
      iconUrl: '',
      iconData: achievement.icon,
  ...
  Color _getRarityColor(AchievementRarity rarity) {
    switch (rarity) {
      case AchievementRarity.common:
        return AppColors.primaryCyan; // Cyan
