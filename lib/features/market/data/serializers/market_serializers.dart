  ...
  MarketTickersMapSerializer()
      : super(
          ...
          fromJson: (json) {
            ...
            return map.map(
              (k, v) =>
                  MapEntry(k, MarketTicker.fromJson(v as Map<String, dynamic>)),
            );
          },
        );
}
...
class MarketTickerSerializer extends JsonCacheSerializer<MarketTicker> {
  MarketTickerSerializer()
      : super(
          ...
          fromJson: (json) =>
              MarketTicker.fromJson(json as Map<String, dynamic>),
        );
}

/// Serializer for `List<MarketCandle>` payload.
class MarketCandleListSerializer
    extends JsonCacheSerializer<List<MarketCandle>> {
